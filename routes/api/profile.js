...
router.post(
  ...
  [
    auth,
    [
      check("status", "Status must be a string").not().isEmpty(),
      check("skills", "Skills must be a array of strings").not().isEmpty(),
    ],
  ],
  async (req, res) => {
...
router.delete("/experience/:exp_id", auth, async (req, res) => {
  try {
    ...
    if (removeIndex == -1) {
      return res.status(404).send({ msg: "Cannot found this experience" });
    }
...
router.delete("/education/:edu_id", auth, async (req, res) => {
  try {
    ...
    if (removeIndex == -1) {
      return res.status(404).send({ msg: "Cannot found this education" });
    }
